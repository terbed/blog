...
All the default jekyll markdown features are made available such that they don't cause any conflict with the custom features that we have implemented. To see how to the raw markdown gets generated, go to the [[Example Page to View Markdown Rendering]]
...
For setting up the theme on your website checkout [[How-To Setup Enjoyment work jekyll]].
